...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://durin.wiki";
    ...
    "@graph": [
      {
        ...
        name: "Durin Wiki",
        description:
          "Complete Durin Wiki covering builds, teams, weapons, artifacts, materials, lore, and banner updates for Genshin Impact.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Durin character trailer key visual",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        url: siteUrl,
        description:
          "Complete Durin Wiki resource hub for builds, teams, materials, talents, and lore guides.",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Durin Wiki hero artwork",
        },
        sameAs: [
          "https://genshin.hoyoverse.com/en/",
          "https://discord.com/invite/genshinimpact",
      ...
      },
      {
        "@type": "VideoGame",
        name: "Durin",
        gamePlatform: ["PC", "PlayStation", "Mobile"],
      ...
      {
        "@type": "VideoObject",
        name: "Character Trailer - Durin: A Story Born for This",
        description:
          "Official Genshin Impact character trailer featuring Durin.",
        uploadDate: "2025-12-01",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/MOkyO-PYAGY",
        url: "https://www.youtube.com/watch?v=MOkyO-PYAGY",
      },
    ],
  };
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="MOkyO-PYAGY"
              title="Character Trailer - Durin: A Story Born for This"
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://x.com/GenshinImpact"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
