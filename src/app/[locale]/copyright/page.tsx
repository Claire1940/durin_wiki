...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Durin Wiki',
    description: 'Copyright and intellectual property information for Durin Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Durin Wiki',
      title: 'Copyright Notice - Durin Wiki',
      description: 'Copyright and intellectual property information for Durin Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Durin Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Durin Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Durin Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Genshin Impact platform ecosystem</li>
              <li><strong>Durin Developers</strong> - Creators of the Durin game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Durin</strong> - Trademark of the game developers</li>
              <li><strong>Durin Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Durin Wiki<br />
              Email: <a href="mailto:dmca@durin.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@durin.wiki</a>
            </p>
            <p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@durin.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@durin.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@durin.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@durin.wiki</a>
            </p>
            <p>
